...
|---------------------|------------|----------
| apiKey              | credentials| The api key obtained from Stripe.
| transferId          | credentials| The identifier of the transfer to be reversed.
...
```json
{	"apiKey": "...",
	"transferId": "tr_191bZGH8tdm6eq3TKKWZ0DtJ",
}
```
#### Response example
```json
{
	...
	"contextWrites":{
		"#":{
			"to": {
			  "id": "trr_191bZGH8tdm6eq3TQjfYF2bx",
			  ...
			  "transfer": "tr_191bZGH8tdm6eq3TKKWZ0DtJ"
			}
		}
	}
}
